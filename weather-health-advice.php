...
<body>
    ...
    <main class="d-flex flex-nowrap" style="margin-top:2rem;">
        ...
        <div class="d-flex flex-column align-items-stretch flex-shrink-0 text-bg-dark" style="width: 400px;">
        ...
        <div class="b-example-divider b-example-vr" style="margin-right:1rem;"></div>
